...
<?php if(isset($_POST['submit_button'])) {	
	...
	$dt = date(''.$date2[2].'-'.$date2[0].'-'.$date2[1].'',time());
	...
	if($_FILES['photo']['name'] != NULL) {
			...
			echo	$imageurl = $movefile['url'];
			
			$wpdb->insert('wp_0k8kmyk1bc_participants_database', array('section'=>$_POST['section'] , 'lot'=>$_POST['lot'] , 'compass'=>$_POST['compass'] , 'owner_1_last_name'=>$_POST['owner_1_last_name'] , 'owner_1'=>$_POST['owner_1'] , 'address'=>$_POST['address']  , 'city'=>$_POST['city'] , 'state'=>$_POST['state'] , 'zip'=>$_POST['zip'] , 'phone'=>$_POST['phone'] , 'email_primary'=>$_POST['email_primary'] , 'owner_2'=>$_POST['owner_2'] , 'asofdate'=> $dt , 'lot_purchase_date'=>$_POST['lot_purchase_date'] , 'lot_purchase_price'=>$_POST['lot_purchase_price'] , 'burial_last'=>$_POST['burial_last'] , 'burial_first'=>$_POST['burial_first'] , 'burial_middle'=>$_POST['burial_middle'] , 'burial_suffix'=>$_POST['burial_suffix'] , 'burial_display_name'=>$_POST['burial_display_name'] , 'burial_number'=>$_POST['burial_number'] , 'burial_type'=>$_POST['burial_type'] , 'date_of_death'=>$_POST['date_of_death'] , 'date_of_burial'=>$_POST['date_of_burial'] , 'funeral_home'=>$_POST['funeral_home'] , 'bronze_type'=>$_POST['bronze_type'] , 'bronze_set'=>$_POST['bronze_set'] , 'bronze_storage'=>$_POST['bronze_storage'] , 'veteran'=>$_POST['veteran'] , 'service_branch'=>$_POST['service_branch'] , 'notes'=>$_POST['notes'] , 'map_section'=> 'a:2:{i:0;s:87:"'.$_POST['map_section1'].'";i:1;s:4:"'.$_POST['map_section2'].'";}' , 'section_lots'=> 'a:2:{i:0;s:92:"'.$_POST['section_lots1'].'";i:1;s:4:"'.$_POST['section_lots2'].'";}' , 'deed_transfer'=>$_POST['deed_transfer'] , 'transfer_from_name'=>$_POST['transfer_from_name'] , 'deed_transfer_date'=>$_POST['deed_transfer_date']  , 'website'=> $sociallink , 'audio'=> $audiosql ,  'video'=> $videosql ,   'docs'=> $docssql , 'pictures'=> $picssql  , 'date_of_birth'=> $_POST['date_of_birth'] ,  'photo'=> $imageurl , 'gps_latitude'=> $_POST['gps_latitude'] ,  'gps_longitude'=> $_POST['gps_longitude']  ));
			
			
			 //$wpdb->insert('wp_0k8kmyk1bc_participants_database', array( 'burial_display_name'=>"test s", 'burial_number'=>$_POST['burial_number'] , 'burial_type'=>$_POST['burial_type'] , 'date_of_death'=>$_POST['date_of_death'] , 'date_of_burial'=>$_POST['date_of_burial'] , 'funeral_home'=>$_POST['funeral_home'] , 'bronze_type'=>$_POST['bronze_type'] , 'bronze_set'=>$_POST['bronze_set'] , 'bronze_storage'=>$_POST['bronze_storage'] , 'veteran'=>$_POST['veteran'] , 'service_branch'=>$_POST['service_branch'] , 'notes'=>$_POST['notes'] , 'map_section'=> 'a:2:{i:0;s:87:"'.$_POST['map_section1'].'";i:1;s:4:"'.$_POST['map_section2'].'";}' , 'section_lots'=> 'a:2:{i:0;s:92:"'.$_POST['section_lots1'].'";i:1;s:4:"'.$_POST['section_lots2'].'";}' , 'deed_transfer'=>$_POST['deed_transfer'] , 'transfer_from_name'=>$_POST['transfer_from_name'] , 'deed_transfer_date'=>$_POST['deed_transfer_date'] , 'photo'=> $imageurl , 'website'=> $sociallink , 'audio'=> $audiosql ,  'video'=> $videosql ,   'docs'=> $docssql , 'pictures'=> $picssql   , 'date_of_birth'=> $_POST['date_of_birth']  ));			
			...
			$wpdb->insert('wp_0k8kmyk1bc_participants_database', array('section'=>$_POST['section'] , 'lot'=>$_POST['lot'] , 'compass'=>$_POST['compass'] , 'owner_1_last_name'=>$_POST['owner_1_last_name'] , 'owner_1'=>$_POST['owner_1'] , 'address'=>$_POST['address']  , 'city'=>$_POST['city'] , 'state'=>$_POST['state'] , 'zip'=>$_POST['zip'] , 'phone'=>$_POST['phone'] , 'email_primary'=>$_POST['email_primary'] , 'owner_2'=>$_POST['owner_2'] , 'asofdate'=> $dt , 'lot_purchase_date'=>$_POST['lot_purchase_date'] , 'lot_purchase_price'=>$_POST['lot_purchase_price'] , 'burial_last'=>$_POST['burial_last'] , 'burial_first'=>$_POST['burial_first'] , 'burial_middle'=>$_POST['burial_middle'] , 'burial_suffix'=>$_POST['burial_suffix'] , 'burial_display_name'=>$_POST['burial_display_name'] , 'burial_number'=>$_POST['burial_number'] , 'burial_type'=>$_POST['burial_type'] , 'date_of_death'=>$_POST['date_of_death'] , 'date_of_burial'=>$_POST['date_of_burial'] , 'funeral_home'=>$_POST['funeral_home'] , 'bronze_type'=>$_POST['bronze_type'] , 'bronze_set'=>$_POST['bronze_set'] , 'bronze_storage'=>$_POST['bronze_storage'] , 'veteran'=>$_POST['veteran'] , 'service_branch'=>$_POST['service_branch'] , 'notes'=>$_POST['notes'] , 'map_section'=> 'a:2:{i:0;s:87:"'.$_POST['map_section1'].'";i:1;s:4:"'.$_POST['map_section2'].'";}' , 'section_lots'=> 'a:2:{i:0;s:92:"'.$_POST['section_lots1'].'";i:1;s:4:"'.$_POST['section_lots2'].'";}' , 'deed_transfer'=>$_POST['deed_transfer'] , 'transfer_from_name'=>$_POST['transfer_from_name'] , 'deed_transfer_date'=>$_POST['deed_transfer_date']  , 'website'=> $sociallink , 'audio'=> $audiosql ,  'video'=> $videosql ,   'docs'=> $docssql , 'pictures'=> $picssql  , 'date_of_birth'=> $_POST['date_of_birth']  ));
	...
	<div id="successfull" style="padding:20px; text-align:center; font-size:25px; font-weight:bold;">Add Successful</div>
...
<br style="clear:both;" />
	...
	<p>Add a record in the table below. To move to the next field in the same row, press TAB or click the cell in the next field.</p>
<div class="wrap pdb-signup pdb-instance-2 ">

    <form method="post" enctype="multipart/form-data" autocomplete="off" action="/add-a-record/#successfull"><input name="action" type="hidden" value="signup">
	  ...
	  <tbody class="field-group field-group-submit">
        ...
        <tr>
          <td class="submit-buttons">
           ...
           <input name="submit_button" type="submit" class="button-primary pdb-submit" value="Add Record">
      ...
      <tbody class="field-group field-group-main">
        ...
        <tr class="text-line">
          ...
          <td>
            ...
            <input name="owner_1_last_name" id="pdb-owner_1_last_name" type="text" class=" regular-text" value="<?php 	echo $row->owner_1_last_name; ?>" required>
        ...
        <tr class="date">
          ...
          <td>
            ...
            <input name="asofdate" id="pdb-asofdate" type="text" class=" regular-text date_field" value="<?php
			echo date("m/d/Y", substr($row->asofdate, 0, 10));
...
<button type="button" id="resetbtn" style="float: right;  color: white; margin-top: -16px;">Reset</button>
...
<th for="pdb-website">Website, Blog or Social Media Link</th>
...
<div class="row" id="social1">
        ...
        <tr class="text-area">
          ...
          <td>
			...
			<div class="row">
			<button class="btn btn-warning" onclick="addMoreRows3(this.form);" type="button" style="margin: 0 10px 10px 15px;">Add New docs</button>    
			</div>    
        ...
        <tr class="text-area">
          ...
          <td>
			...
			<div class="row">
			<button class="btn btn-warning" onclick="addMoreRows4(this.form);" type="button" style="margin: 0 10px 10px 15px;">Add New pictures</button>    
			</div>    
